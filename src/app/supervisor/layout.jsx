...
export default function SupervisorLayout({ children }) {
  ...
  const excludedRoutes = ["/supervisor/login"];
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64 flex flex-col">
            ...
            <nav className="text-sm text-blue-500 mb-4">
              <ol className="list-none p-0 inline-flex">
                <li className="flex items-center">
                  <a href="/supervisor/overview" className="hover:text-blue-700">Dashboard</a>
        ...
        <footer className="mt-auto p-4 text-center text-sm text-gray-500 border-t border-gray-200">
          <p>&copy; {new Date().getFullYear()} Admin Supervisor Dashboard. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
