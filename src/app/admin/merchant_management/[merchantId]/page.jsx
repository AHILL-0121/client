...
const MerchantInfo = ({ params }) => {
    ...
    const fetchMerchantDetails = async () => {
      try {
        ...
        const response = await axios.get(
          `${apiBaseUrl}/merchant_management/${params.merchantId}`,
          {
            headers: {
    ...
    handleConfirmation(
      async () => {
        try {
          ...
          await axios.delete(`${apiBaseUrl}/deleteMerchant/${params.merchantId}`, {
            headers: {
          ...
          setShowPopup(true);
          router.push("/admin/merchant_management");
        } catch (error) {
  ...
  const onHoldMerchant = () => {
    handleConfirmation(
      async () => {
        try {
          const token = localStorage.getItem("adminToken");
          await axios.put(
            `${apiBaseUrl}/merchant_management/${params.merchantId}/hold`,
            {},
            {
              headers: {
                Authorization: `Bearer ${token}`,
      ...
      "Are you sure you want to deactivate this merchant? All their products will also be deactivated."
    );
  };

  // Function to release merchant from hold
  const onReleaseMerchant = () => {
    handleConfirmation(
      async () => {
        try {
          const token = localStorage.getItem("adminToken");
          await axios.put(
            `${apiBaseUrl}/merchant_management/${params.merchantId}/release`,
            {},
            {
              headers: {
                Authorization: `Bearer ${token}`,
      ...
      "Are you sure you want to activate this merchant? All their products will also be activated."
    );
  };
