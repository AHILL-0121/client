    ...
    <div className="h-16 bg-white flex items-center justify-between px-6 shadow-md z-20 border-b border-blue-100 w-full">
      <div className="flex items-center">
        <h2 className="text-xl font-semibold text-blue-900">
          <span className="text-blue-600 font-bold">Welcome,</span> {adminName}
        </h2>
          ...
          {isDropdownOpen && (
            <div className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-blue-100 z-50">
              <div className="py-1" role="menu" aria-orientation="vertical">
                <a href="/admin/profile" className="block px-4 py-2 text-sm text-blue-700 hover:bg-blue-50" role="menuitem">
                  Your Profile
                </a>
                <a href="/admin/settings" className="block px-4 py-2 text-sm text-blue-700 hover:bg-blue-50" role="menuitem">
                  Settings
                </a>
                <button
